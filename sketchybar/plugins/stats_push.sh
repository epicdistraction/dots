...
STAT_LABEL_CHAR_WIDTH="${STAT_LABEL_CHAR_WIDTH:-9}"
STAT_PILL_X_PADDING="${STAT_PILL_X_PADDING:-2}"
STAT_CPU_LABEL_WIDTH_TRIM="${STAT_CPU_LABEL_WIDTH_TRIM:-8}"
STAT_ITEM_GAP="${STAT_ITEM_GAP:-20}"
STAT_STATS_SPAN_WIDTH="${STAT_STATS_SPAN_WIDTH:-930}"
STAT_GRAPH_COUNT="${STAT_GRAPH_COUNT:-4}"
